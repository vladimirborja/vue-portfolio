        ...
        <div class="max-w-5xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div v-for="project in projects" :key="project.name"
                    class="border border-green-900/60 bg-green-950/10 rounded-lg p-6 flex flex-col justify-between hover:border-green-600/50 transition-colors duration-300">
                    <div>
