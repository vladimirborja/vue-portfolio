...
<template>
    <section id="skills" v-scroll-reveal class="py-24 border-t border-green-200/50 dark:border-green-900/40 relative">
        ...
        <div class="max-w-5xl mx-auto px-6">
            ...
            <!-- Heading -->
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-12 tracking-tight">Tech Stack</h2>
            ...
            <div class="grid grid-cols-3 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-9 gap-4">
                <div v-for="skill in skills" :key="skill.name"
                    ...
                    <span
                        class="font-mono-custom text-[10px] text-gray-600 dark:text-gray-400 text-center leading-tight">{{
                        skill.name }}</span>
                </div>
            </div>
            ...
            <div class="mt-20">
                ...
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-12 tracking-tight">What I've
                    earned</h2>
