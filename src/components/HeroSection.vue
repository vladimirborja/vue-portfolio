...
<template>
    <section id="hero" class="relative min-h-screen flex items-center pt-14 bg-cover bg-center"
        style="background-image: linear-gradient(rgba(10,10,10,0.85), rgba(10,10,10,0.95)), url('/src/assets/hero-bg.jpg')">
        <div class="max-w-5xl mx-auto px-6 py-24 w-full">
            ...
            <div class="flex gap-4 flex-wrap">
                <button @click="document.getElementById('projects').scrollIntoView({ behavior: 'smooth' })"
                    class="font-mono-custom text-sm px-5 py-2.5 bg-green-500 text-black font-bold hover:bg-green-400 transition-colors duration-200 rounded">
                    view my work
                </button>
